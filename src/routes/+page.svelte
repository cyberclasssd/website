...
<div class="font-mono bg-kuroi text-white min-h-screen">
  ...
  <main class="max-w-3xl sm:m-auto px-8">
    ...
    <Box
      outerClass="mt-4"
      innerClass="p-2 pb-8"
      outerClipPath="polygon(0 0, 100% 0, 100% calc(100% - 1rem), 0% 100%)"
      innerClipPath="polygon(0 0, 100% 0, 100% calc(100% - 1rem), 0% 100%)"
    >
      ...
      <p class="my-2">
        ...
        cover a broad range of security concepts including web security, reverse
    ...
    <Box
      color="limey"
      outerClass="-mt-2"
      innerClass="p-2 pt-8 text-right"
      outerClipPath="polygon(0 1rem, 100% 0, 100% 100%, 0% 100%)"
      innerClipPath="polygon(0 1rem, 100% 0, 100% 100%, 0% 100%)"
    >
      <h3 class="text-xl font-bold">ADVANCED CAMP</h3>
      <h4 class="italic">June 27 - July 1st</h4>
      <p class="my-2">
        ...
        Cyberclass Summer Camp, or if they already have a basic background in
