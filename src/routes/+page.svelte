    ...
    <section>
      ...
      >
        ...
        <p class="my-2">
          ...
          cover a broad range of security concepts including web security,
          reverse engineering, Linux hardening, and more in an interactive,
      ...
      <Box
        ...
        outerClipPath="polygon(0 1.5rem, 100% 0, 100% 100%, 0% 100%)"
